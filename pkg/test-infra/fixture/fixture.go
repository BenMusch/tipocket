...
func init() {
	...
	flag.StringVar(&Context.TiDBClusterConfig.TiDBMonitorInitializerImage, "monitor-initializer-image", "pingcap/tidb-monitor-initializer:nightly", "tidb-monitor image, defaults to latest if untagged")
	flag.StringVar(&Context.TiDBClusterConfig.TiDBMonitorReloaderImage, "monitor-reloader-image", "pingcap/tidb-monitor-reloader:v1.0.1", "tidb-monitor-reloader image, defaults to latest if untagged")
